#Programa que simula um jogo de memória com 16 cartas e grava os resultados em um arquivo texto para comparar quem obteve o menor tempo e maior quantidade de pontos para disputa.
